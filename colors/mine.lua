...
hi('String',         { link = 'Letter' })
hi('Character',      { link = 'Letter' })
...
hi('DiagnosticError',            { fg = 'Orange',                          ctermfg = 1 })
hi('DiagnosticWarn',             { fg = 'Yellow',                       ctermfg = 3 })
hi('DiagnosticInfo',             { fg = 'LightBlue',                    ctermfg = 4 })
hi('DiagnosticHint',             { fg = 'LightGrey',                    ctermfg = 7 })
hi('DiagnosticOk',               { fg = 'LightGreen',                   ctermfg = 10 })
hi('DiagnosticUnderlineError',   { sp = 'Red', underline = false,        cterm = { underline = false } })
hi('DiagnosticUnderlineWarn',    { sp = 'Orange', underline = false,     cterm = { underline = false } })
hi('DiagnosticUnderlineInfo',    { sp = 'LightBlue', underline = false,  cterm = { underline = false } })
hi('DiagnosticUnderlineHint',    { sp = 'LightGrey', underline = false,  cterm = { underline = false } })
hi('DiagnosticUnderlineOk',      { sp = 'LightGreen', underline = false, cterm = { underline = false } })
...
if vim.o.background == 'light' then
  ...
  hi('FoldColumn',       { fg = 'DarkBlue',                             ctermfg = 'DarkBlue' })
  ...
  hi('SignColumn',       { fg = 'DarkBlue',                             ctermfg = 'DarkBlue' })
  ...
  hi('Identifier',       { fg = 'Cyan',                             ctermfg = 'DarkCyan' })
  ...
  -- Default colors only used with a dark background (closer to original Vim)
  ...
  hi('FoldColumn',       { fg = 'Cyan', ctermfg = 'Cyan' })
  ...
  hi('MoreMsg',          { fg = 'Green', bold = true, ctermfg = 'Green' })
  hi('Question',         { fg = 'Green', bold = true, ctermfg = 'Green' })

  hi('Pmenu',            { bg = 'DarkGrey', fg = 'White', ctermbg = 'DarkGrey', ctermfg = 'White' })
  hi('PmenuSel',         { bg = 'Black', fg = 'White', ctermbg = 'Black', ctermfg = 'White' })
  ...
  hi('StatusLineTerm',   { fg = 'Black', bg = 'Green', bold = true, ctermfg = 'Black', ctermbg = 'Green', cterm = { bold = true } })
  hi('StatusLineTermNC', { fg = 'Black', bg = 'Green', ctermfg = 'Black', ctermbg = 'Green' })

  hi('TabLine',          { bg = 'DarkGrey', ctermfg = 'Black', ctermbg = 'DarkGrey' })
  hi('Title',            { fg = 'Magenta', bold = true, ctermfg = 'Magenta' })

  hi('Visual',           { fg = 'Black', bg = 'Grey', ctermfg = 'Black', ctermbg = 'Grey' })
  hi('WarningMsg',       { fg = 'Red', ctermfg = 'Red' })

  hi('Comment',          { fg = 'Cyan', ctermfg = 'Cyan' })
  hi('Constant',         { fg = 'Magenta', ctermfg = 'Magenta' })
  hi('Special',          { fg = 'Red', ctermfg = 'Red' })
  hi('Identifier',       { fg = 'Cyan', ctermfg = 'Cyan' })
  hi('Statement',        { fg = 'Yellow', bold = true, ctermfg = 'Yellow' })
  hi('PreProc',          { fg = 'Magenta', ctermfg = 'Magenta' })
  hi('Type',             { fg = 'Green', bold = true, ctermfg = 'Green' })

  hi('Underlined',       { fg = 'Blue', underline = true, ctermfg = 'Blue', cterm = { underline = true } })
  hi('Ignore',           { ctermfg = 'Black' })

  hi('Added',            { fg = 'Green', ctermfg = 'Green' })
  hi('Changed',          { fg = 'Blue', ctermfg = 'Blue' })
  hi('Removed',          { fg = 'Red', ctermfg = 'Red' })
end
--stylua: ignore end
