...
if vim.o.background == 'light' then
  ...
  hi('Pmenu',            { bg = '#240319', fg = 'White',                   ctermfg = 'White', ctermbg = 'DarkGrey' })
  hi('PmenuSel',         { bg = '#610b45', fg = 'White',               ctermfg = 'White', ctermbg = 'Black' })
  ...
  hi('TabLine',          { bg = 'DarkGrey', underline = false,           ctermfg = 'Black', ctermbg = 'DarkGrey', cterm = { underline = true } })
  ...
  hi('Special',          { fg = 'White',        bold = true,              ctermfg = 'LightRed' })
  hi('Identifier',       { fg = 'Cyan',                                 ctermfg = 'White', cterm = { bold = true } })
  hi('Statement',        { fg = '#ffc014', bold = true,                  ctermfg = 'Yellow' })
